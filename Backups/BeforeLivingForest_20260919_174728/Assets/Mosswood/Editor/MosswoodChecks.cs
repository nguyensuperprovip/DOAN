...
namespace Mosswood.Editor {
 public static class MosswoodChecks {
  ...
  // Legacy single-scene checks. Use DOAN/Expansion/Verify campaign for the current game.
  ...
  public static void BuildWindows(){
   ...
   var r=BuildPipeline.BuildPlayer(new BuildPlayerOptions{scenes=System.Array.ConvertAll(System.Array.FindAll(EditorBuildSettings.scenes,s=>s.enabled),s=>s.path),locationPathName=Output+"Mosswood/DOAN-Mosswood.exe",target=BuildTarget.StandaloneWindows64,options=BuildOptions.None});
