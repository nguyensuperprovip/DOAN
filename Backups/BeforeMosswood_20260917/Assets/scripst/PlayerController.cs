...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            if (GameUIManager.Instance.CurrentState == GameUIManager.GameState.Paused && Input.GetKeyDown(KeyCode.Escape))
            {
    ...
    private IEnumerator GameOverRoutine()
    {
        ...
        {
            GameUIManager.Instance.ShowGameOver(false, GameUIManager.Instance.KillCount, Time.time - gameStartTime);
        }
    }
